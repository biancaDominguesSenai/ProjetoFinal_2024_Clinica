        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form method="POST" action="/projetofinal_2024_clinica/save-paciente" >
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row botao">
                            <div class="col-md-12">
                            <form class="d-flex" method="POST" action="/projetofinal_2024_clinica/list-paciente" class="nav-link hover-zoom" >
                ...
                <div class="col-md-4 float-end">
                    <img class="float-end" src="../../projetofinal_2024_clinica/views/Imagens/cadastro_paciente.jpg" alt="Cadastro Paciente">
                </div>
            </div>
        </div>
    </section>
