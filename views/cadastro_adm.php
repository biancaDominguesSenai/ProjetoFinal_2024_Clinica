...
<head>
    ...
    <link rel="shortcut icon" href="../../projetofinal_2024_clinica/vews/Imagens/logo_icon.png" type="image/x-icon">
    <link rel="stylesheet" href="../../projetofinal_2024_clinica/views/css/cadastro.css">

    <title>SP Medical Group - Cadastro ADM</title>
</head>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form method="POST" action="/projetofinal_2024_clinica/save-adm">
                    <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input name="senhaAcesso" type="text" class="form-control" placeholder="Senha de Acesso" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row botao">
                            <div class="col-md-12">
                            <form class="d-flex" method="POST" action="/projetofinal_2024_clinica/list-adm" class="nav-link hover-zoom" >
                ...
                <div class="col-md-4 float-end">
                    <img class="float-end" src="../../projetofinal_2024_clinica/views/Imagens/cadastro_organizador.png" alt="Cadastro Paciente">
                </div>
            </div>
        </div>
      </div>  
